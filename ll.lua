...
local Window = Library.CreateLib("KEXD HUB ","GrapeTheme")
--เเท็บ
...
local Section = Tab:NewSection("KILL YOUR SEFT  ")
Section:NewButton("KILL", " ", function()
 require(4694654493).load("ur name here lol")
end)
